...
/// Engineering calculation error types with surgical precision
#[derive(Debug, Clone)]
pub enum EngineeringError {
    ...
    /// Design code compliance violation
    ComplianceViolation {
        code: String,
        requirement: String,
        actual: String,
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::ComplianceViolation { code, requirement, actual } => {
                write!(
                    f,
                    "Design code '{}' violation: required '{}', actual '{}'",
        ...
        match self {
            Self::CalculatorNotFound(calc) => (
                ...
                ErrorResponse {
                    ...
                    suggestions: vec![
                        "Check available calculators at /api/v1/calculus/engineer/catalogue".to_string(),
            ...
            Self::MissingParameter { parameter, calculator } => (
                ...
                ErrorResponse {
                    ...
                    suggestions: vec![
                        ...
                        format!("See calculator metadata for '{}' at /api/v1/calculus/engineer/catalogue", calculator),
                    ],
                },
            ),
            ...
            Self::DomainError { field, message } => (
                ...
                ErrorResponse {
                    ...
                    suggestions: vec![
                        ...
                        format!("Check '{}' for realistic engineering values", field),
                    ],
                },
            ),
            ...
            Self::SafetyViolation { parameter, required, actual } => (
                ...
                ErrorResponse {
                    ...
                    details: Some(ErrorDetails {
                        ...
                        constraints: Some(vec!["Design code safety requirement".to_string()]),
                    }),
                    suggestions: vec![
                        "Increase structural dimensions or material strength".to_string(),
                        "Review load combinations and factors".to_string(),
                        "Consider alternative design approach".to_string(),
                    ],
                },
            ),
            ...
            Self::ComplianceViolation { code, requirement, actual } => (
                ...
                ErrorResponse {
                    ...
                    suggestions: vec![
                        ...
                        "Adjust design to meet code specifications".to_string(),
                        "Consult with licensed PE for compliance verification".to_string(),
                    ],
                },
            ),
...
impl IntoResponse for EngineeringError {
...
/// Result type alias for engineering calculations
pub type EngineeringResult<T> = Result<T, EngineeringError>;
...
mod tests {
    ...
    fn test_missing_parameter_error() {
        let err = EngineeringError::MissingParameter {
            parameter: "dimensions.height".to_string(),
            calculator: "beam_design".to_string(),
        };
    ...
    fn test_safety_violation_error() {
        let err = EngineeringError::SafetyViolation {
            parameter: "FOS_overturning".to_string(),
            required: 2.0,
            actual: 1.5,
        };
