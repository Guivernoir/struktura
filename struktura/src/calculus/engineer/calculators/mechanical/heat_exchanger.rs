...
mod tests {
    ...
    #[tokio::test]
    async fn test_heat_exchanger_basic() {
        let calc = HeatExchangerCalculator;
        
        let mut params = minimal_parameters();
        let mut additional = HashMap::new();
        additional.insert("t_hot_in".to_string(), 80.0);
        additional.insert("t_hot_out".to_string(), 50.0);
        additional.insert("t_cold_in".to_string(), 20.0);
        additional.insert("t_cold_out".to_string(), 40.0);
        additional.insert("mass_flow_hot".to_string(), 10.0);
        additional.insert("mass_flow_cold".to_string(), 15.0);
        additional.insert("u_value".to_string(), 850.0);
    ...
    #[test]
    fn test_temperature_cross() {
        let calc = HeatExchangerCalculator;
        
        let mut params = minimal_parameters();
        let mut additional = HashMap::new();
        additional.insert("t_hot_in".to_string(), 80.0);
        additional.insert("t_hot_out".to_string(), 30.0);
        additional.insert("t_cold_in".to_string(), 20.0);
        additional.insert("t_cold_out".to_string(), 50.0);
        additional.insert("mass_flow_hot".to_string(), 10.0);
        additional.insert("mass_flow_cold".to_string(), 15.0);
        params.additional = Some(additional);
